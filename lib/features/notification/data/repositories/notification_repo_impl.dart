...
class NotificationRepoImpl implements NotificationRepo
{
  ...
  @override
  Future<Either<Failure, List<NotificationModel>>> getNotification({required int page}) async{
    List<NotificationModel> notifications=[];
   try
       {
         var response=await apiHelper.getData(url: ApiEndPoints.notification,query: {'page':page});
